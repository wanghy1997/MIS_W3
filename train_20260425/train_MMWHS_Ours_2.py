...
parser.add_argument('--remark', type=str, default='ours_2', help='remark')
...
if __name__ == "__main__":
    ...
    save_best_path = "/data/why/logs/MMWHS_Ours_10_AblationStudy_2/epoch_3600_dice_0.7680_best.pth"
    # save_best_path = "/data/why/logs/MMWHS_Ours_50_AblationStudy_2/epoch_2000_dice_0.8746_best.pth"
