...
parser.add_argument('--data_path', type=str, default='/data/why/Datasets/MMWHS/', help='data_path')
parser.add_argument('--log_path', type=str, default='/data/why/logs/', help='log_path')
parser.add_argument('--exp', type=str, default='TAK', help='exp_name')
parser.add_argument('--remark', type=str, default='TAK', help='remark')
...
parser.add_argument('--max_epoch', type=int, default=4000, help='maximum epoch number to train')
...
parser.add_argument('--start_contrast_epoch', type=int, default=1000, help='start contrastive loss epoch')
...
def train(labeled_list, unlabeled_list):
    ...
    weight_scheduler = AnatomyWeightScheduler(
        ...
        warmup_epochs=20, # 假设前 20% 的时间用来打基础
    ...
    for epoch_num in tqdm(range(args.max_epoch + 1), dynamic_ncols=True, position=0):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            with autocast(dtype=torch.float16):
                ...
                mix_features, mix_features_embedding_list, _, clip_embedding = model.module.forward_encoder(img_cross_mix, do_contrast)  # 做混合后的预测
                del img_cross_mix, _
                ...
                with torch.no_grad():
                    ...
                    if iter_num > 100:
                        ...
                        unmix_pl = cube_losses.get_mix_pl_baseline(ema_model.module, feat_list[labeled_bs:],
                                                          clip_embedding,
...
if __name__ == "__main__":
    ...
    # save_best_path = "/data/why/logs//MMWHS_Ours_50_consistency/epoch_4900_dice_0.9052_best.pth"
    save_best_path = "/data/why/logs/MMWHS_TAK_50_TAK/epoch_1200_dice_0.8787_best.pth"
...
# CUDA_VISIBLE_DEVICES=0 python train_MMWHS_AB.py --seed 1337 --label_num 10 --remark "AB_onlyClass" 
# CUDA_VISIBLE_DEVICES=0 python train_MMWHS_AB.py --seed 1337 --label_num 50 --remark "AB_onlyClass" 
# CUDA_VISIBLE_DEVICES=0 python train_MMWHS_Ours.py --seed 1337 --label_num 50 --remark "Ratoty" 
# CUDA_VISIBLE_DEVICES=0 python train_MMWHS_TAK.py --seed 1337 --label_num 10 --remark "TAK" 
# CUDA_VISIBLE_DEVICES=1 python train_MMWHS_TAK.py --seed 1337 --label_num 50 --remark "TAK" 