...
parser.add_argument('--remark', type=str, default='ours_3', help='remark')
...
if __name__ == "__main__":
    ...
    # save_best_path = "/data/why/logs/MMWHS_Ours_10_AblationStudy_3/epoch_4800_dice_0.7911_best.pth"
    # save_best_path = "/data/why/logs/MMWHS_Ours_50_AblationStudy_3/epoch_3600_dice_0.8893_best.pth"
