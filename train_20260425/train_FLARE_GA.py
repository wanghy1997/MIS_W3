...
from utils_ori import ramps, test_util, cube_losses, cube_utils
...
parser.add_argument('--root_path', type=str, default='/data/why/Datasets/FLARE/', help='Name of Dataset')
parser.add_argument('--save_path', type=str, default='/data/why/logs/', help='path to save')
...
parser.add_argument('--max_epoch', type=int, default=10, help='maximum iteration to train')
...
snapshot_path = args.save_path + "/{}_{}_{}_{}".format(args.dataset_name, args.exp, args.label_num, args.remark)
...
if __name__ == "__main__":
    ...
    save_best_path = '/data/why/logs//FLARE_GA_50_ours/iter_00400_dice_0.185987_best.pth'
    model = create_model(n_classes=num_classes, cube_size=cube_size, patch_size=patch_size[0])
    model.load_state_dict(torch.load(save_best_path, weights_only=True))
    model.eval()
    _, _, metric_final = test_util.validation_all_case_flare(model,
                                                            num_classes=num_classes,
                                                            base_dir=train_data_path,
                                                            image_list=eval_list,
                                                            patch_size=patch_size, 
