    ...
    for epoch_num in tqdm(range(args.max_epoch + 1), dynamic_ncols=True, position=0):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            with autocast(dtype=torch.float16):
                ...
                loss = supervised_loss + 0.1*loc_loss + consistency_weight*consistency_loss + con_w*loss_con*0.000001
        ...
        if iter_num % 200 == 0 and epoch_num > 19:
        # if epoch_num % 5 == 0:
...
if __name__ == "__main__":
    ...
    # save_best_path = "/data/why/logs/AMOS_Ours_10_Ratoty/epoch_99_dice_0.7161_best.pth"
    save_best_path = "/data/why/logs/AMOS_Ours_50_Ratoty/epoch_149_dice_0.7428_best.pth"
...
# CUDA_VISIBLE_DEVICES=1 python train_AMOS_test04.py --seed 1337 --label_num 50 --remark "Ratoty"