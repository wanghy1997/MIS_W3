...
parser.add_argument('--remark', type=str, default='ours_1', help='remark')
...
if __name__ == "__main__":
    ...
    save_best_path = "/data/why/logs/MMWHS_Ours_10_AblationStudy_1/epoch_3400_dice_0.7767_best.pth"
    # save_best_path = "/data/why/logs/MMWHS_Ours_50_AblationStudy_1/epoch_2000_dice_0.8974_best.pth"
