...
snapshot_path = args.log_path + "/{}_{}_{}_baseline".format(args.dataset_name, args.exp, args.label_num)
...
# CUDA_VISIBLE_DEVICES=0 python train_AMOS_MagicNet_GA_TAK.py --seed 1337 --label_num 10 