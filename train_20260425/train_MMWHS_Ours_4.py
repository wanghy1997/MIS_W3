...
parser.add_argument('--remark', type=str, default='ours_4', help='remark')
...
parser.add_argument('--max_epoch', type=int, default=15000, help='maximum epoch number to train')
...
def train(labeled_list, unlabeled_list):
    ...
    for epoch_num in tqdm(range(args.max_epoch + 1), dynamic_ncols=True, position=0):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            with autocast(dtype=torch.float16):
                ...
                with torch.no_grad():
                    ...
                    if epoch_num > args.start_contrast_epoch-2:
                ...
                consistency_loss += consistency_loss_unmix * (args.sem_pl_w * sem_weight.detach())
        ...
        if epoch_num % 200 == 0 and epoch_num > 19:
        # if epoch_num % 5 == 0:
...
if __name__ == "__main__":
    ...
    save_best_path = "/data/why/logs/MMWHS_Ours_10_AblationStudy_4/epoch_3600_dice_0.7903_best.pth"
    # save_best_path = "/data/why/logs/MMWHS_Ours_50_AblationStudy_4/epoch_3000_dice_0.8992_best.pth"
    ...
    _, _, metric_final = test_util.validation_all_case_MMWHS(model, num_classes=num_classes, base_dir=train_data_path,
                                                       image_list=test_list, patch_size=patch_size, stride_xy=90,
                                                                                     stride_z=80,save_nii_dir=snapshot_path)
