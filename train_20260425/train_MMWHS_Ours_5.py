...
parser.add_argument('--remark', type=str, default='ours_5', help='remark')
...
if __name__ == "__main__":
    ...
    # save_best_path = "/data/why/logs/MMWHS_Ours_10_AblationStudy_5/epoch_2800_dice_0.8560_best.pth"
    # save_best_path = "/data/why/logs/MMWHS_Ours_50_AblationStudy_5/epoch_1200_dice_0.8992_best.pth"
