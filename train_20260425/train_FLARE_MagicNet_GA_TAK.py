...
from loss_synapse import GADice, GACE, ContrastiveLoss
...
snapshot_path = args.log_path + "/{}_{}_{}_fuxian".format(args.dataset_name, args.exp, args.label_num)
...
def train(labeled_list, unlabeled_list, eval_list):
    ...
    for epoch_num in tqdm(range(args.max_epoch + 1), dynamic_ncols=True, position=0):
        ...
        # if epoch_num % 5 == 0:
            ...
            model.eval()
            dice_all, std_all, metric_all_cases = test_util.validation_all_case_fast(model,
